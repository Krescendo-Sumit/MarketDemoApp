package mahyco.market.demo.view.login;
        ...
        try {
            ...
            if (success) {
                try {
                    ...
                    JSONObject jsonTokenDetails = jsonObject1.getJSONObject("getTokenModel");
             //       Toast.makeText(context, "" + jsonTokenDetails.getString("Role"), Toast.LENGTH_SHORT).show();
             // Allow Only TMB and RBM Means User Role id Shouldbe 3 and 4
                 //   if (jsonTokenDetails.getInt("RoleId") == 3 || jsonTokenDetails.getInt("RoleId") == 4) {
                        ...
                        Preferences.save(context, Preferences.PARENT_EMP_CODE, jsonTokenDetails.getString("ParentEmpCode"));
                        Preferences.save(context, Preferences.PARENT_EMP_ID, jsonTokenDetails.getString("ParentId"));
